...
exports.generateDAO = void 0;
var auxiliaries_1 = require("../src/Common/Utils/auxiliaries");
var fs_1 = require("fs");
var generateDAO = function (path, tableName) { return __awaiter(void 0, void 0, void 0, function () {
    var className, factoryPath, daoPath, files;
    return __generator(this, function (_a) {
        className = (0, auxiliaries_1.removeDoctive)(tableName);
        className = (0, auxiliaries_1.snakeToCamelCase)(className);
        factoryPath = "Persistence/DAO/Factories";
        daoPath = "Persistence/DAO/" + className;
        console.info("Generating " + daoPath);
        files = generateFiles(className);
        addFactory(className);
        if (!(0, fs_1.existsSync)(path + "/" + daoPath)) {
            (0, fs_1.mkdirSync)(path + "/" + daoPath);
        }
        if (!(0, fs_1.existsSync)(path + "/" + factoryPath)) {
            (0, fs_1.mkdirSync)(path + "/" + factoryPath);
        }
        (0, fs_1.writeFileSync)(path + "/" + daoPath + "/I" + className + "DAO.ts", files.interface);
        (0, fs_1.writeFileSync)(path + "/" + daoPath + "/" + className + "DAO.ts", files.concrete);
        (0, fs_1.writeFileSync)(path + "/" + factoryPath + "/AbstractDAOFactory.ts", factories.abstract);
        (0, fs_1.writeFileSync)(path + "/" + factoryPath + "/PsqlDAOFactory.ts", factories.concrete);
        return [2 /*return*/];
    });
}); };
exports.generateDAO = generateDAO;
var generateFiles = function (className) {
    var files = {
        concrete: '',
        interface: ''
    };
...
var addFactory = function (className) {
